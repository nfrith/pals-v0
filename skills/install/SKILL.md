...
Do not interview for modules, entities, skills, or delamains here. Those belong to `/new` (create from scratch) or `/foundry` (pull from the curated shelf), both invoked in Phase 8.
...
Do not author any modules, skills, or delamains. Those arrive via `/new` or `/foundry` in Phase 8.
...
## Phase 8: Pick next step and hand off
...
| Stop here | No invocation. Proceed to Phase 9. |
| Other | Interpret the operator's instruction. If it maps to an existing skill, invoke it. Otherwise explain next steps and proceed to Phase 9. |
...
- Phase 8 outcome — which skill was invoked, or "stopped at skeleton"
