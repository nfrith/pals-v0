...
- v0 is deprecated and will be deleted at a future date.
- The working reference implementation is `v1/example-systems/centralized-metadata-happy-path/`. The compiler is being built to match this intended solution.

## Rules

- The SDR process defined in `v1/sdr/AGENTS.md` must be followed when recording spec decisions.
