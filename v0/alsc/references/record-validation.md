...
1. `alsc/references/frontmatter-schema-definition.md`
2. `alsc/references/content-schema-definition.md`
3. `alsc/references/module-schema-definition.md`
...
1. Parse `MODULE.md` and validate it against `alsc/references/module-schema-definition.md`.
...
5. Build a canonical identity index for reference resolution:
   - key: canonical URI string `als://<namespace>/<module>/<qualified-logical-path>`
...
5. Parse ref values as markdown links:
   - form: `[display](als://<namespace>/<module>/<entity>/<id>(/<entity>/<id>)*)`
...
1. URI parses as `als://<namespace>/<module>/<entity>/<id>(/<entity>/<id>)*`.
...
1. `alsc/references/compiler-error-shape.md`
2. `alsc/references/diagnostic-codes.md`
