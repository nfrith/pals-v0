...
1. Per-record validation semantics are defined in `alsc/references/record-validation.md`.
2. Entity schema file frontmatter shape is defined in `alsc/references/frontmatter-schema-definition.md`.
3. Entity schema body shape is defined in `alsc/references/content-schema-definition.md`.
4. Module skill filesystem/router shape is defined in `alsc/references/module-skill-definition.md`.
