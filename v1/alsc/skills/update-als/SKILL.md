...
Use this skill for ALS changes that affect meaning, validation, compiler behavior, or the normative examples that define those rules. Drive the work from settled semantics through SDRs, fixtures, canonical shape-language documentation, compiler changes, and tests.
