...
This document defines the allowed frontmatter shape for ALS schema files:
...
This file defines only schema-file frontmatter shape. Record validation semantics are defined in `alsc/references/record-validation.md`.
