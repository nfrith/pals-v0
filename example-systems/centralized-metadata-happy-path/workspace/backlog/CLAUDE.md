...
Type is destiny. An app item and a research item have fundamentally different lifecycles. The type discriminator isn't a label — it determines what sections are available, what statuses are valid, and what "done" means. Pick the right type at creation. If the type is wrong, create a new item.
